    ...
    <div class="container py-5">
        <div class="row d-flex justify-content-between align-items-center g-5">
            <div class="col-lg-3 col-md-6 text-lg-start text-center">
                <h5 class="text-white mb-2">Kantor Kami</h5>
                <p class="mb-2">
                ...
                <p class="mb-1 d-inline-flex align-items-center">
                    <a href="mailto:informasimetrixeducation@gmail.com" target="_blank" rel="noopener noreferrer">
                        <i class="fa fa-envelope me-3"></i>informasimetrixeducation@gmail.com</a>
                </p>
            </div>
            ...
            <div class="col-lg-3 col-md-8 text-lg-end text-center">
                <h5 class="text-white mb-2">Jam Operasional</h5>
