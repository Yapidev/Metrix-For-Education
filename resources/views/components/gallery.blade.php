            ...
            <div class="row g-0">
                <div class="col-12">
                    <a class="d-block" href="{{ asset('img/gallery-5.jpg') }}" data-lightbox="gallery">
                        <img class="img-fluid" src="{{ asset('img/gallery-5.jpg') }}" alt="gallery-photo">
                    </a>
                </div>
                <div class="col-12">
                    <a class="d-block" href="{{ asset('img/gallery-1.jpg') }}" data-lightbox="gallery">
                        <img class="img-fluid" src="{{ asset('img/gallery-1.jpg') }}" alt="gallery-photo">
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="row g-0">
                <div class="col-12">
                    <a class="d-block" href="{{ asset('img/gallery-2.jpg') }}" data-lightbox="gallery">
                        <img class="img-fluid" src="{{ asset('img/gallery-2.jpg') }}" alt="gallery-photo">
                    </a>
                </div>
                <div class="col-12">
                    <a class="d-block" href="{{ asset('img/gallery-6.jpg') }}" data-lightbox="gallery">
                        <img class="img-fluid" src="{{ asset('img/gallery-6.jpg') }}" alt="gallery-photo">
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="row g-0">
                <div class="col-12">
                    <a class="d-block" href="{{ asset('img/gallery-7.jpg') }}" data-lightbox="gallery">
                        <img class="img-fluid" src="{{ asset('img/gallery-7.jpg') }}" alt="gallery-photo">
                    </a>
                </div>
                <div class="col-12">
                    <a class="d-block" href="{{ asset('img/gallery-3.jpg') }}" data-lightbox="gallery">
                        <img class="img-fluid" src="{{ asset('img/gallery-3.jpg') }}" alt="gallery-photo">
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="row g-0">
                <div class="col-12">
                    <a class="d-block" href="{{ asset('img/gallery-4.jpg') }}" data-lightbox="gallery">
                        <img class="img-fluid" src="{{ asset('img/gallery-4.jpg') }}" alt="gallery-photo">
                    </a>
                </div>
                <div class="col-12">
                    <a class="d-block" href="{{ asset('img/gallery-8.jpg') }}" data-lightbox="gallery">
                        <img class="img-fluid" src="{{ asset('img/gallery-8.jpg') }}" alt="gallery-photo">
                    </a>
                </div>
            </div>
        </div>
